...
class ComicViewController(
    ...
    inner class LatestNumberCallback : BaseCallback<Int?> {
        ...
        // TODO: finite state machine
        override fun invoke(value: Int?) {
            this@ComicViewController.latestNumber = value
        }
    }
    ...
    inner class ComicResourseCallback : BaseCallback<BaseResource<ComicData>> {
        ...
        override fun invoke(value: BaseResource<ComicData>) {
            ...
            if (value.data != null) {
                ...
                val latestNumber = this@ComicViewController.latestNumber // TODO: architecture
                if (latestNumber != null) {
                    this@ComicViewController.latestNumber = max(latestNumber, value.data.num)
                } else {
                    this@ComicViewController.latestNumber = value.data.num  // TODO: finite state machine
                }
